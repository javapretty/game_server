...
enum Master_DB_Message {
	...
	SYNC_MASTER_DB_SAVE_OFFLINE_MSG = 150104, //保存离线信息
	SYNC_MASTER_DB_DROP_OFFLINE_MSG = 150105, //删除离线信息
	...
	SYNC_DB_MASTER_SAVE_OFFLINE_MSG = 550104, //保存离线信息(返回)
	SYNC_DB_MASTER_DROP_OFFLINE_MSG = 550105, //删除离线信息(返回)
};
