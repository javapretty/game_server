...
enum Master_DB_Message {
	...
	SYNC_MASTER_DB_DROP_GUILD_INFO = 150103, //删除公会信息
	SYNC_MASTER_DB_SAVE_OFFLINE_INFO = 150104, //保存离线信息
	SYNC_MASTER_DB_DROP_OFFLINE_INFO = 150105, //删除离线信息
	SYNC_DB_MASTER_LOAD_PUBLIC_INFO = 550101, //加载公共信息(返回)
	SYNC_DB_MASTER_SAVE_GUILD_INFO = 550102, //保存公会信息(返回)
	SYNC_DB_MASTER_DROP_GUILD_INFO = 550103, //删除公会信息(返回)
	SYNC_DB_MASTER_SAVE_OFFLINE_INFO = 550104, //保存离线信息(返回)
	SYNC_DB_MASTER_DROP_OFFLINE_INFO = 550105, //删除离线信息(返回)
};
