...
enum Client_Game_Message {
	...
	REQ_ADD_HERO_EXP = 120306, //增加英雄经验
...
enum Game_Client_Message {
	...
	RES_ADD_HERO_EXP = 520306, //增加英雄经验(返回)
...
enum Gate_Message {
	...
	SYNC_GATE_MASTER_PLAYER_SIGNOUT = 140101, //gate同步玩家下线到master
...
enum Game_DB_Message {
	...
	SYNC_GAME_DB_DELETE_DATA = 150008, //删除数据库信息
...
enum Master_DB_Message {
	SYNC_MASTER_DB_LOAD_DATA = 150101, //拉取数据库信息
	SYNC_MASTER_DB_DELETE_DATA = 150102, //删除数据库信息
	SYNC_MASTER_DB_SAVE_GUILD_INFO = 150103, //保存公会信息
	SYNC_MASTER_DB_SAVE_OFFLINE_INFO = 150104, //保存离线信息
	SYNC_MASTER_DB_SAVE_RANK_INFO = 150105, //保存排行榜信息
	SYNC_DB_MASTER_LOAD_GUILD_INFO = 550103, //加载公会信息
	SYNC_DB_MASTER_LOAD_OFFLINE_INFO = 550104, //加载离线信息
	SYNC_DB_MASTER_LOAD_RANK_INFO = 550105, //加载排行榜信息
};
