...
enum ErrCode {
		...
		ERROR_PACK_FULL						= 10000100,				//背包已满
		ERROR_MONEY_TYPE_ILLEGAL  = 10000101,					//金钱类型非法
		ERROR_ITEM_FORBID_DROP		= 10000102,
		ERROR_ITEM_NOT_EXIST			= 10000103,
		ERROR_PACK_LOCK						= 10000104,
		ERROR_ITEM_NOT_ENOUGH			= 10000105,
		ERROR_NO_ITEM_GET					= 10000106,
		ERROR_MONEY_OVER_LIMIT		= 10000107,
		ERROR_ALL_COPPER_NOT_ENOUGH	= 10000108,
		ERROR_COPPER_NOT_ENOUGH		= 10000109,
		ERROR_BIND_COPPER_NOT_ENOUGH	= 10000110,
		ERROR_COUPON_NOT_ENOUGH		= 10000111,
		ERROR_GOLD_NOT_ENOUGH			= 10000112,
		ERROR_UNBIND_ITEM_NOT_ENOUGH= 10000113,
		ERROR_BIND_ITEM_NOT_ENOUGH= 10000114,
		ERROR_PACK_INDEX_NOT_EXIST= 10000115,
};
