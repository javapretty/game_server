...
if (typeof Msg_MD == "undefined") {
	...
	Msg_MD.SYNC_MASTER_DB_SAVE_RANK_INFO = 150105; //保存排行榜信息
	Msg_MD.SYNC_DB_MASTER_LOAD_GUILD_INFO = 550103; //加载公会信息
	Msg_MD.SYNC_DB_MASTER_LOAD_OFFLINE_INFO = 550104; //加载离线信息
	Msg_MD.SYNC_DB_MASTER_LOAD_RANK_INFO = 550105; //加载排行榜信息
}
