...
if (typeof Msg_MD == "undefined") {
	...
	Msg_MD.SYNC_MASTER_DB_SAVE_RANK = 150104; //保存排行榜信息
	Msg_MD.SYNC_MASTER_DB_SAVE_OFFLINE = 150105; //保存离线信息
	Msg_MD.SYNC_DB_MASTER_CREATE_GUILD = 550100; //创建公会(返回)
	Msg_MD.SYNC_DB_MASTER_LOAD_GUILD = 550103; //加载公会信息
	Msg_MD.SYNC_DB_MASTER_LOAD_RANK = 550104; //加载排行榜信息
	Msg_MD.SYNC_DB_MASTER_LOAD_OFFLINE = 550105; //加载离线信息
}
